...
class TransferController extends Controller
{
    ...
    // {
    //     $allData = Transfer::orderBy('id', 'desc')->with('fromWarehouse', 'toWarehouse', 'transferItems')->get();
    ...
    //     // Logic for storing transfer will go here
    //     // For now, just return success
    //     return redirect()->route('all.transfer')->with('success', 'Transfer created successfully');
    // }
    public function AllTransfer()
    {
